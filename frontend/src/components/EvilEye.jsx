...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    const noiseData = generateNoiseTexture(128);
    ...
    function update(time) {
      ...
      if (paused || document.hidden || time - lastRender < 1000 / maxFps) return;
      lastRender = time;
  ...
  }, [eyeColor, intensity, pupilSize, irisWidth, glowIntensity, scale, noiseScale, pupilFollow, flameSpeed, backgroundColor, lightMode, paused, maxFps]);
